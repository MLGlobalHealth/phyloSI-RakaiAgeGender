...
if( ! indir.deepsequencedata == "" ){
  ...
  file.characteristics_sequenced_ind_R14_18 <- file.path(indir.deepsequence_analyses, "PANGEA2_RCCS", "participants_count_by_gender_loc_age", "characteristics_sequenced_ind_R14_18_230710.rds")
  file.characteristics_ever_sequenced <- file.path(indir.deepsequence_analyses, "PANGEA2_RCCS", "participants_count_by_gender_loc_age", "characteristics_ever_sequenced_230710.rds")
  file.characteristics_sequenced_R14_18 <- file.path(indir.deepsequence_analyses, "PANGEA2_RCCS", "participants_count_by_gender_loc_age", "characteristics_sequenced_R14_18_230710.rds")
