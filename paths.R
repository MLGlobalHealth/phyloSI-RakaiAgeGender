...
if(zenodo.exists)
{
    ...
    dir.zenodo.surproc = file.path(dir.zenodo, "preprocessed_RCCS_surveillance")
...
path.meta.randomized <- file.path(gitdir.data,"Rakai_Pangea2_RCCS_Metadata_randomized.RData" )
path.collection.dates.randomized <- file.path(gitdir.data, 'sequences_collection_dates_randomized.rds')
