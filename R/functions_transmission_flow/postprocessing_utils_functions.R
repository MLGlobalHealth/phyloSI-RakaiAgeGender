...
clean_contribution_sexual_contact_yu <- function(contribution_sexual_contact){
  ...
  # keep only some variable
  contribution_sexual_contact <- contribution_sexual_contact[, .(LABEL_SOURCE, AGEYRS,M, CL, CU)]
  contribution_sexual_contact <- merge(contribution_sexual_contact, df_direction, by = 'LABEL_SOURCE')
