...
compare.hiv.allhiv.firstpositivedates <- function(hiv, allhiv)
{
  ...
  tmp[, date_first_positive := as.character(date_first_positive)]
  firstpos_update[, date_first_positive := as.character(date_first_positive)]
  tmp[, date_last_negative := as.character(date_last_negative)]
  firstpos_update[, date_last_negative := as.character(date_last_negative)]
