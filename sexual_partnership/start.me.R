...
if (1)
{
  ...
  args$run_analysis <- list(
    run_Poisson_BSGP_inland_rho_MF = 1,
    run_Poisson_BSGP_fishing_rho_MF = 1,
    run_Poisson_HSGP_inland_rho_MF = 0,
    run_Poisson_HSGP_fishing_rho_MF = 0,
    run_negbin_BSGP_inland_rho_MF = 1,
    run_negbin_BSGP_fishing_rho_MF = 1,
    run_negbin_HSGP_inland_rho_MF = 0,
    run_negbin_HSGP_fishing_rho_MF = 0,
    run_Poisson_BSGP_inland = 0,
    run_Poisson_BSGP_fishing = 0,
    run_Poisson_HSGP_inland = 0,
    run_Poisson_HSGP_fishing = 0,
    run_negbin_BSGP_inland = 0,
    run_negbin_BSGP_fishing = 0,
    run_negbin_HSGP_inland = 0,
    run_negbin_HSGP_fishing = 0
  )
  ...
  # define which datase
  # args$data_set_total <- 'RCCS_sexp1yr_220514.csv'
  args$data_set <- 'RCCS_reported_partnership_220519.csv'
...
# Considering the missing age-gender reports and just estimate using Male reports----
# Run Poisson BSGP Inland----
if (args$run_analysis$run_Poisson_BSGP_inland_rho_MF)
{
  ...
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_BSGP_Poisson_rho_MF.R'),
                ' --pkg_dir $pkg_dir',
  ...
  cmd <- paste0(cmd, tmp, '\n')
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_postprocessing_Poisson_rho_MF.R'),
                ' --seed $seed',
                ' --pkg_dir $pkg_dir',
...
if (args$run_analysis$run_Poisson_BSGP_fishing_rho_MF)
{
...
if (args$run_analysis$run_Poisson_HSGP_inland_rho_MF)
{
  ...
  cmd <- paste0(cmd,"out_dir_base=",tmpdir,"\n")
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_HSGP_Poisson_rho_MF.R'),
                ' --pkg_dir $pkg_dir',
                ' --out_dir_base $out_dir_base',
                ' --seed $seed',
                ' --data_set $data_set',
...
if (args$run_analysis$run_Poisson_HSGP_fishing_rho_MF)
{
...
if (args$run_analysis$run_negbin_BSGP_inland_rho_MF)
{
  ...
  cmd <- paste0(cmd,"n_knots=",args$n_knots,"\n")
  cmd <- paste0(cmd,"out_dir_base=",tmpdir,"\n")
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_BSGP_NegBin_rho_MF.R'),
                ' --pkg_dir $pkg_dir',
                ' --out_dir_base $out_dir_base',
                ' --seed $seed',
                ' --data_set $data_set',
  ...
  cmd <- paste0(cmd, tmp, '\n')
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_postprocessing_NegBin_rho_MF.R'),
                ' --seed $seed',
                ' --pkg_dir $pkg_dir',
                ' --out_dir $out_dir_base'
  )
...
if (args$run_analysis$run_negbin_BSGP_fishing_rho_MF)
{
...
if (args$run_analysis$run_negbin_HSGP_inland_rho_MF)
{
  ...
  cmd <- paste0(cmd,"hsgp_m=",args$hsgp_m,"\n")
  cmd <- paste0(cmd,"out_dir_base=",tmpdir,"\n")
  tmp <- paste0('Rscript ', file.path('$pkg_dir','scripts','make_partnerships_rate_HSGP_NegBin_rho_MF.R'),
                ' --pkg_dir $pkg_dir',
                ' --out_dir_base $out_dir_base',
                ' --seed $seed',
                ' --data_set $data_set',
...
if (args$run_analysis$run_negbin_HSGP_fishing_rho_MF)
{
...
# didn't add the missing reported participants----
# Run Poisson BSGP Inland----
