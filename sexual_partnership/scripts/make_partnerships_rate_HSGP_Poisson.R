...
args$stan_model <- file.path('stan_models','HSGP.stan')
args$outfile.prefix <- paste0("Poisson_HSGP_c-",args$hsgp_boundary_inflation*100,"_m-",args$hsgp_m,'-comm-', args$community)
