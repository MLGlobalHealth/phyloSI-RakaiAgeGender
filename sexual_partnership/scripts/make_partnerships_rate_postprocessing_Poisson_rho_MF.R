...
# note to get the standard deviation, we can summarise the quantiles of "log_random_effect_baseline + f + log(pop)"
# then get the exp and compute the quantiles
cat("\nExtract age and gender specific contact intensities ...\n")
...
set(pd, NULL, 'value', pd[, exp(log_random_effect_baseline + value + log(pop))])
tmp <- pd[,
          list(sd = sd(value),
